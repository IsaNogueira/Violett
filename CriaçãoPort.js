...
import { StyleSheet, TextInput, TouchableOpacity, Text, View, Modal, Image, ScrollView, Button } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <Text style={styles.perfilText}> Foto de perfil</Text>
        ...
        <Text style={styles.textQuemVoceEh}>Redes Sociais</Text>
        <TextInput style={styles.inputQuemVoceEh} placeholder="Linkedin" underlineColorAndroid="transparent" />
        <TextInput style={styles.inputQuemVoceEh} placeholder="Github" underlineColorAndroid="transparent" />
        <TextInput style={styles.inputQuemVoceEh} placeholder="Facebook" underlineColorAndroid="transparent" />
        </View>

        <View>
        <Text style={styles.textQuemVoceEh}>Qual sua ocupação?</Text>
        <Picker
      ...
      <Button
        ...
        onPress={() => alert('As alterações foram salvas com sucesso')}
        color='#9333FF'
      />
      </View>
      </View>
